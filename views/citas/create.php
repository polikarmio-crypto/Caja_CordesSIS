...
<div class="dashboard-layout">
 ...
 <?= $m['total_ratings'] > 0 ? ' - Valoración: ' . number_format($m['avg_rating'], 1) . ' (' . $m['total_ratings'] . ' valoraciones)' : ' - (Sin valoraciones)' ?>
 ...
 Las citas normales se agendan dentro del turno laboral del médico (por lo general hasta las 17:00). Puedes ver los horarios registrados en <a href="<?= BASE_URL ?>/horarios" style="color: #00ba8b;">Horarios Médicos</a>.
 </div>
 ...
 <strong>Emergencia:</strong> Se puede agendar a cualquier hora del día. El médico será contactado independientemente de su turno habitual.
 </div>
